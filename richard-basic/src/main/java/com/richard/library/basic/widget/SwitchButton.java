...
public class SwitchButton extends View implements Checkable {
    ...
    //点击SwitchButton并且isEnableClickConfirm=true时有效
    private OnClickSwitchButtonListener onClickSwitchButtonListener;

    //是否开启点击确认事件（为true时在点击该SwitchButton时会先回调onClickSwitchButtonListener，不会开启SwitchButton开关，为false时相反）
//    private boolean isEnableClickConfirm;
    ...
    public void setOnClickSwitchButtonListener(OnClickSwitchButtonListener onClickSwitchButtonListener) {
        this.onClickSwitchButtonListener = onClickSwitchButtonListener;
    }
    ...
    public boolean performClick() {
        if(onClickSwitchButtonListener != null){
            onClickSwitchButtonListener.clickSwitchButton(this);
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (/*isEnableClickConfirm && */event.getAction() == MotionEvent.ACTION_DOWN && onClickSwitchButtonListener != null) {
            onClickSwitchButtonListener.clickSwitchButton(this);
            return false;
        }
    ...
    public interface OnClickSwitchButtonListener {
        void clickSwitchButton(View v);
    }
}
