...
public class FragmentUtil {
    ...
    public static void add(@NonNull final FragmentManager fm,
                           ...
                           @IdRes final int containerId,
                           final int showIndex,
                           boolean isExecutePendingTransactions
    ) {
        add(fm, adds.toArray(new Fragment[0]), containerId, null, showIndex,isExecutePendingTransactions);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
        ...
        add(fm, adds, containerId, null, showIndex,isExecutePendingTransactions);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
        ...
        operateNoAnim(TYPE_ADD_FRAGMENT, fm, null,isExecutePendingTransactions, add);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
                           ...
                           @AnimatorRes @AnimRes final int popEnterAnim,
                           @AnimatorRes @AnimRes final int popExitAnim) {
        add(fm, add, containerId, tag, false,isExecutePendingTransactions, enterAnim,
    ...
    public static void add(@NonNull final FragmentManager fm,
        ...
        operate(TYPE_ADD_FRAGMENT, fm, ft, null,isExecutePendingTransactions, add);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
                           ...
                           boolean isExecutePendingTransactions,
                           @NonNull final View... sharedElements) {
        add(fm, add, containerId, tag, isExecutePendingTransactions,false, sharedElements);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
        ...
        add(fm, adds.toArray(new Fragment[0]), containerId, tags, showIndex,isExecutePendingTransactions);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
        ...
        operateNoAnim(TYPE_ADD_FRAGMENT, fm, null,isExecutePendingTransactions, adds);
    }
     ...
     */
    public static void show(@NonNull final Fragment show,boolean isExecutePendingTransactions) {
        putArgs(show, false);
        operateNoAnim(TYPE_SHOW_FRAGMENT, show.getFragmentManager(), null,isExecutePendingTransactions, show);
    }
     ...
     * @param fm The manager of fragment.
     */
    public static void show(@NonNull final FragmentManager fm,boolean isExecutePendingTransactions) {
        List<Fragment> fragments = getFragments(fm);
        for (Fragment show : fragments) {
            putArgs(show, false);
        }
        operateNoAnim(TYPE_SHOW_FRAGMENT, fm, null,isExecutePendingTransactions, fragments.toArray(new Fragment[0]));
    }
     ...
     */
    public static void hide(@NonNull final Fragment hide,boolean isExecutePendingTransactions) {
        putArgs(hide, true);
        operateNoAnim(TYPE_HIDE_FRAGMENT, hide.getFragmentManager(), null,isExecutePendingTransactions, hide);
    }
     ...
     * @param fm The manager of fragment.
     */
    public static void hide(@NonNull final FragmentManager fm,boolean isExecutePendingTransactions) {
        List<Fragment> fragments = getFragments(fm);
        for (Fragment hide : fragments) {
            putArgs(hide, true);
        }
        operateNoAnim(TYPE_HIDE_FRAGMENT, fm, null,isExecutePendingTransactions
    ...
    public static void showHide(@NonNull final Fragment show,
        ...
        showHide(show, Collections.singletonList(hide), isExecutePendingTransactions);
    }
     ...
     */
    public static void showHide(final int showIndex,boolean isExecutePendingTransactions, @NonNull final Fragment... fragments) {
        showHide(fragments[showIndex],isExecutePendingTransactions, fragments);
    }
     ...
     * @param hide The fragment will be hide.
     */
    public static void showHide(@NonNull final Fragment show,boolean isExecutePendingTransactions,
                                @NonNull final Fragment... hide) {
        showHide(show, Arrays.asList(hide),isExecutePendingTransactions);
    }
    ...
    public static void showHide(final int showIndex, @NonNull final List<Fragment> fragments,
                                boolean isExecutePendingTransactions) {
        showHide(fragments.get(showIndex), fragments,isExecutePendingTransactions);
    }
    ...
    public static void showHide(@NonNull final Fragment show, @NonNull final List<Fragment> hide
        ...
        operateNoAnim(TYPE_SHOW_HIDE_FRAGMENT, show.getFragmentManager(), show,
                isExecutePendingTransactions, hide.toArray(new Fragment[0]));
    }
    ...
    public static void showHide(@NonNull final Fragment show,
                                ...
                                @AnimatorRes @AnimRes final int popEnterAnim,
                                @AnimatorRes @AnimRes final int popExitAnim) {
        showHide(show, Collections.singletonList(hide),isExecutePendingTransactions, enterAnim, exitAnim, popEnterAnim, popExitAnim);
    }
    ...
    public static void showHide(final int showIndex, @NonNull final List<Fragment> fragments,
                                ...
                                @AnimatorRes @AnimRes final int popEnterAnim,
                                @AnimatorRes @AnimRes final int popExitAnim) {
        showHide(fragments.get(showIndex), fragments,isExecutePendingTransactions, enterAnim, exitAnim, popEnterAnim, popExitAnim);
    }
    ...
    public static void showHide(@NonNull final Fragment show, @NonNull final List<Fragment> hide,
        ...
        if (fm != null) {
            FragmentTransaction ft = fm.beginTransaction();
            addAnim(ft, enterAnim, exitAnim, popEnterAnim, popExitAnim);
            operate(TYPE_SHOW_HIDE_FRAGMENT, fm, ft, show,isExecutePendingTransactions, hide.toArray(new Fragment[0]));
        }
    }
    ...
    public static void replace(@NonNull final Fragment srcFragment,
                               @NonNull final Fragment destFragment,
                               final boolean isAddStack,
                               final boolean isExecutePendingTransactions,
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(srcFragment, destFragment, null, isAddStack,isExecutePendingTransactions
    ...
    public static void replace(@NonNull final FragmentManager fm,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(fm, fragment, containerId, null, false,isExecutePendingTransactions
                , enterAnim, exitAnim, 0, 0);
    }
    ...
    public static void replace(@NonNull final FragmentManager fm,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(fm, fragment, containerId, null, isAddStack,isExecutePendingTransactions
                , enterAnim, exitAnim, 0, 0);
    }
    ...
    public static void replace(@NonNull final Fragment srcFragment,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(srcFragment, destFragment, destTag, isAddStack,isExecutePendingTransactions
                , enterAnim, exitAnim, 0, 0);
    }
    ...
    public static void replace(@NonNull final Fragment srcFragment,
                               ...
                               @AnimatorRes @AnimRes final int popEnterAnim,
                               @AnimatorRes @AnimRes final int popExitAnim) {
        replace(srcFragment, destFragment, destTag, false,isExecutePendingTransactions,
                enterAnim, exitAnim, popEnterAnim, popExitAnim);
    }
    ...
    public static void replace(@NonNull final Fragment srcFragment,
        ...
        if (fm == null) return;
        Args args = getArgs(srcFragment);
        replace(fm, destFragment, args.id, destTag, isAddStack,isExecutePendingTransactions,
                enterAnim, exitAnim, popEnterAnim, popExitAnim);
    }
    ...
    public static void replace(@NonNull final FragmentManager fm,
        ...
        operate(TYPE_REPLACE_FRAGMENT, fm, ft, null,isExecutePendingTransactions, fragment);
    }
    ...
    public static void replace(@NonNull final FragmentManager fm,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(fm, fragment, containerId, destTag, isAddStack,isExecutePendingTransactions
                , enterAnim, exitAnim, 0, 0);
    }
    ...
    public static void replace(@NonNull final FragmentManager fm,
                               ...
                               @AnimatorRes @AnimRes final int popEnterAnim,
                               @AnimatorRes @AnimRes final int popExitAnim) {
        replace(fm, fragment, containerId, destTag, false,isExecutePendingTransactions,
                enterAnim, exitAnim, popEnterAnim, popExitAnim);
    }
    ...
    public static void replace(@NonNull final FragmentManager fm,
                               ...
                               final boolean isExecutePendingTransactions,
                               final View... sharedElements) {
        replace(fm, fragment, containerId, destTag, false,isExecutePendingTransactions, sharedElements);
    }
     ...
     */
    public static void remove(@NonNull final Fragment remove,final boolean isExecutePendingTransactions) {
        operateNoAnim(TYPE_REMOVE_FRAGMENT, remove.getFragmentManager(), null,isExecutePendingTransactions, remove);
    }
     ...
     * @param isIncludeSelf True to include the fragment, false otherwise.
     */
    public static void removeTo(@NonNull final Fragment removeTo, final boolean isIncludeSelf,final boolean isExecutePendingTransactions) {
        operateNoAnim(TYPE_REMOVE_TO_FRAGMENT, removeTo.getFragmentManager(), isIncludeSelf ?
                removeTo : null,isExecutePendingTransactions, removeTo);
    }
     ...
     * @param fm The manager of fragment.
     */
    public static void removeAll(@NonNull final FragmentManager fm,final boolean isExecutePendingTransactions) {
        List<Fragment> fragments = getFragments(fm);
        operateNoAnim(TYPE_REMOVE_FRAGMENT, fm, null,isExecutePendingTransactions
                , fragments.toArray(new Fragment[0]));
    }
    ...
    private static void operateNoAnim(final int type,
                                      @Nullable final FragmentManager fm,
                                      final Fragment src,
                                      boolean isExecutePendingTransactions,
                                      Fragment... dest) {
        if (fm == null) return;
        FragmentTransaction ft = fm.beginTransaction();
        operate(type, fm, ft, src,isExecutePendingTransactions, dest);
    }
    ...
    private static void operate(final int type,
        ...
        if (isExecutePendingTransactions) {
