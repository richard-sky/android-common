...
import static com.richard.library.basic.widget.NumberProgressBar.ProgressTextVisibility.Invisible;
import static com.richard.library.basic.widget.NumberProgressBar.ProgressTextVisibility.Visible;
...
public class NumberProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawReachedBar) {
            ...
            canvas.drawRoundRect(mReachedRectF, radius, radius, mReachedBarPaint);
        }

        if (mDrawUnreachedBar) {
//            canvas.drawRect(mUnreachedRectF, mUnreachedBarPaint);
            canvas.drawRoundRect(mUnreachedRectF, radius, radius, mUnreachedBarPaint);
        }
