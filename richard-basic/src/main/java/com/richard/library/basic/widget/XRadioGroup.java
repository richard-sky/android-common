...
/**
 * author Richard
 * date 2018/12/24 11:39
 * version V1.0
 * description: 多层级嵌套RadioGroup
 */
public class XRadioGroup extends LinearLayout {
     ...
     *
     * @param listener the callback to dial on checked state change
     */
    ...
    public void setCheckValidate(CheckValidate checkValidate) {
     ...
     * 选中验证回调
     */
    public interface CheckValidate {
        boolean isCanCheck(int checkedId);
    }

    private class CheckedStateTracker implements CompoundButton.OnCheckedChangeListener {
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            int id = buttonView.getId();
            if (checkValidate != null && !checkValidate.isCanCheck(id)) {
