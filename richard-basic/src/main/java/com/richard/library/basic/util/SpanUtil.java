...
//            this.fontSize = (int) (size * fontScale + 0.5f);
            this.fontSize = DensityUtilKt.sp2px(size);
        } else {
            this.fontSize = size;
        }
        return this;
     ...
     * @return the single {@link SpanUtil} instance
     */
    public SpanUtil setHorizontalAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link SpanUtil} instance
     */
    public SpanUtil setVerticalAlign(@Align final int align) {
     ...
     * @return the single {@link SpanUtil} instance
     */
    public SpanUtil setClickSpan(@ColorInt final int color,
...
//            LogUtils.e(fm, sfm);
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(AppContext.getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            AppContext.get().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(AppContext.getResources(), bitmap);
                    drawable.setBounds(
