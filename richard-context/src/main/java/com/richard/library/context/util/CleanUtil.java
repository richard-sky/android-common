...
public final class CleanUtil {
    ...
    public static void resetAppData() {
        CleanUtil.cleanInternalCache();
        CleanUtil.cleanInternalFiles();
        CleanUtil.cleanInternalDbs();
        CleanUtil.cleanInternalSp();
        CleanUtil.cleanExternalCache();
    }
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(AppContext.get().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(AppContext.get().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(new File(AppContext.get().getFilesDir().getParent(), "databases"));
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return AppContext.get().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSp() {
        return deleteFilesInDir(new File(AppContext.get().getFilesDir().getParent(), "shared_prefs"));
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && deleteFilesInDir(AppContext.get().getExternalCacheDir());
    }
