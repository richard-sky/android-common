...
public final class ImmersionBar implements ImmersionCallback {
     ...
     * @param dialog   the dialog
     */
    public static void destroy(Activity activity, @NonNull Dialog dialog) {
    ...
    public boolean isHideBar() {
        return mBarParams != null && mBarParams.barHide != BarHide.FLAG_SHOW_BAR;
    }
     ...
     * 是否已设置titleBarView
     */
    public boolean isSetTitleBarView() {
        return mBarParams.titleBarView != null;
    }
