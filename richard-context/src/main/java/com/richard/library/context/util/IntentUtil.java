...
public final class IntentUtil {
    ...
    public static Intent getInstallAppIntent(final File file) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = AppContext.get().getPackageName() + ".provider";
            uri = FileProvider.getUriForFile(AppContext.get(), authority, file);
        }
    ...
    public static Intent getLaunchAppIntent(final String pkgName) {
        String launcherActivity = IntentUtil.getLauncherActivity(pkgName);
    ...
    public static Intent getShareTextImageIntent(@Nullable final String content, final String imagePath) {
        return getShareTextImageIntent(content, FileUtil.getFileByPath(imagePath));
    }
    ...
    public static Intent getShareTextImageIntent(@Nullable final String content,
        ...
        if (imagePaths != null) {
            for (String imagePath : imagePaths) {
                File file = FileUtil.getFileByPath(imagePath);
                if (file != null) {
                    files.add(file);
                }
            }
