...
public class CustomTrustManager implements X509TrustManager {
    ...
    /**
     * No-op. Never invoked by test_client, only used in server-side implementations
     * @return
     */
     ...
     * for test_client SSL authentication based on the authentication type. The authentication type is
     ...
     * @param authType the authentication type based on the test_client certificate
