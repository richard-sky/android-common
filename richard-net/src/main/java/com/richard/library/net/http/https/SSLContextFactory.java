...
import com.richard.library.net.http.util.Base64;
 ...
 * Builds an SSLContext with custom KeyStore and TrustStore, to work with a test_client cert signed by a self-signed CA cert.
 */
public class SSLContextFactory {
    ...
    /**
     * Creates an SSLContext with the test_client and server certificates
     *
     * @param clientCertFile     A File containing the test_client certificate
     * @param clientCertPassword Password for the test_client certificate
     * @param caCertString       A String containing the server certificate
     * @return An initialized SSLContext
     * @throws Exception
     */
    public SSLParams makeContext(InputStream clientCertFile, String clientCertPassword, String caCertString) throws Exception {
        ...
        sslParams.setTrustManager((X509TrustManager) trustManagers[0]);
    ...
    /**
     * Produces a KeyStore from a PKCS12 (.p12) certificate file, typically the test_client certificate
     *
     * @param certificateFile    A file containing the test_client certificate
