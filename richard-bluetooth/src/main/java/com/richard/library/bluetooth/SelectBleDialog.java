...
public class SelectBleDialog extends AppCompatDialogFragment {
    ...
    private void startScan() {
        ...
        if (isOpenBluetooth()) {
            adapter.clear();
            adapter.update(BleUtil.getBondedDeviceList(getContext(), bluetoothAdapter));
    ...
    private final ScanCallback scanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            adapter.update(new BleDevice(result.getDevice(), result.getRssi(), result.getScanRecord().getBytes(), result.getTimestampNanos()));
        }
