...
import com.richard.library.context.util.media.player.SoundPoolUtil;
 ...
 */
public final class VoiceSpeaker3 {
    ...
    private static VoiceSpeaker3 instance;

    public static VoiceSpeaker3 get() {
        if (instance != null) {
            return instance;
        }
        synchronized (VoiceSpeaker3.class) {
            if (instance == null) {
                instance = new VoiceSpeaker3();
            }
        }
        return instance;
    }
    ...
    public static class Builder {
        ...
        public void buildAndSpeak() {
            VoiceSpeaker3.get().speak(prefix, numString, suffix);
        }
    }
