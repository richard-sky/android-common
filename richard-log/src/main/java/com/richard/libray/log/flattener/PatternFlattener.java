...
public class PatternFlattener implements Flattener, Flattener2 {
    ...
    public CharSequence flatten(long timeMillis, String bizType, int logLevel, String tag, String message) {
        ...
        for (ParameterFiller parameterFiller : parameterFillers) {
            flattenedLog = parameterFiller.fill(flattenedLog, timeMillis, bizType, logLevel, tag, message);
        }
        return flattenedLog;
    }
    ...
    static class DateFiller extends ParameterFiller {
        ...
        @Override
        protected String fill(String pattern, long timeMillis, String bizType, int logLevel, String tag, String message) {
    ...
    abstract static class ParameterFiller {
         ...
         */
        protected abstract String fill(String pattern, long timeMillis, String bizType, int logLevel, String tag, String message);
    }
}
