...
package com.richard.libray.log;
...
import com.richard.libray.log.interceptor.Interceptor;
import com.richard.libray.log.internal.DefaultsFactory;
import com.richard.libray.log.internal.Platform;
import com.richard.libray.log.internal.SystemCompat;
import com.richard.libray.log.internal.util.StackTraceUtil;
import com.richard.libray.log.printer.Printer;
import com.richard.libray.log.printer.PrinterSet;
...
public class Logger {
     ...
     * @param msg     日志内容
     */
    public void biz(String bizType, String msg) {
        printlnInternal(bizType, LogLevel.DEBUG, msg);
    }
     ...
     * @param msg     日志内容
     */
    public void biz(String bizType, String tag, String msg) {
        printlnInternal(bizType, LogLevel.DEBUG, tag, msg);
    }
    ...
    public void json(String json) {
        ...
        printlnInternal(null, LogLevel.DEBUG, logConfiguration.jsonFormatter.format(json));
    }
    ...
    public void xml(String xml) {
        ...
        printlnInternal(null, LogLevel.DEBUG, logConfiguration.xmlFormatter.format(xml));
    }
    ...
    private <T> void println(int logLevel, T object) {
        ...
        printlnInternal(null, logLevel, objectString);
    }
    ...
    private void println(int logLevel, Object[] array) {
        ...
        printlnInternal(null, logLevel, Arrays.deepToString(array));
    }
    ...
    private void println(int logLevel, String format, Object... args) {
        ...
        printlnInternal(null, logLevel, formatArgs(format, args));
    }
    ...
    /*package*/ void println(int logLevel, String msg) {
        ...
        printlnInternal(null, logLevel, msg != null ? msg : "");
    }
    ...
    private void println(int logLevel, String msg, Throwable tr) {
        ...
        printlnInternal(null, logLevel, ((msg == null || msg.length() == 0)
     ...
     * @param msg      the message you would like to log
     */
    private void printlnInternal(String bizType, int logLevel, String msg) {
        this.printlnInternal(bizType, logLevel, logConfiguration.tag, msg);
    }
     ...
     * @param msg      the message you would like to log
     */
    private void printlnInternal(String bizType, int logLevel, String tag, String msg) {
        ...
        printer.println(bizType, logLevel, tag, logConfiguration.withBorder
