...
public class XLog {
     ...
     * @param msg     日志内容
     */
    public static void biz(String bizType, String msg) {
        assertInitialization();
        sLogger.biz(bizType, msg);
    }
     ...
     * @param msg     日志内容
     */
    public static void biz(String bizType, String tag, String msg) {
        assertInitialization();
        sLogger.biz(bizType, tag, msg);
    }
